...
const ajouter_champs = (choix) => {
    ...
    if(champ_a_ajouter == 'nom' && !champs_visible.includes('nom')){
        ...
        <div class="zone_text">
            ...
            <input id="PPR" name="PPR" type="text" placeholder="PPR">
        </div>
        `;
        ...
        <div class="zone_text">
            ...
            <input id="CNE" name="CNE" type="text" placeholder="CNE">
        </div>
        `;
        ...
        <div class="zone_text">
            ...
            <input id="numero" name="numero" type="text" placeholder="Numéro de téléphone">
        </div>
        `;
