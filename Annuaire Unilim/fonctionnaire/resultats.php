...
session_start();
    ...
    $resultats = resultats_rechercher_direct(); //appelle de la function 
...
<?php if (isset($_SESSION['ID'], $_SESSION['DESCRIPTION'], $_POST['recherche_button']) && ($_SESSION['DESCRIPTION'] =="fonctionnaire" || $_SESSION['DESCRIPTION'] =="enseignant")) :?>
    <?php if($_SESSION['COMPTE_ACTIVE'] == 1) : //on verifie toujours si le compte est actif?>
        ...
        <div class="resultats">
            ...
            <h2 class="resultats_count"><?=$count_resultats?></h2> <!--ligne 10-->
            <?php if ($count >0):?>
            <table class="tableau_de_resultats">
                <tr>
                    <!-- Pour la recherche on a afficher le nom/prenom/email/numer de telephone-->
                    <th>Nom</th>
                    <th>Prenom</th>
                    <th>Email</th>
